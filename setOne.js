...
const screamFunction = (scream1, scream2) => console.log(`The first parameter is ${scream1}. The second parameter is ${scream2}.`)

screamFunction('Hallejluah', 43)
...
const callbackFnc = (fullName) => console.log(`Hello, my full name is ${fullName}`)
...
greeting('David', 'Bodine', callbackFnc)
...
// console.log(pricesPlusTax([3, 4, 5,], (totalCost) => console.log(`This new array + tax =  ${totalCost}`)))
...
pricesPlusTax([3, 4, 5,], (totalCost) => console.log(`This new array + tax =  ${totalCost}`))
...
/* 
Now, timesFour is the new function (the inner function that was being returned when we invoked 'multiplyingFactory' function). The number 3 that we passed in as a first number is 
