...
contains(names, 'Ty', result => {
  if(result === true){
    console.log('Ty is in the array')
  } else {
    console.log('Ty is not in the array')
  }
})
